...
from static_model_wrapper import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='../TSB-AD/Datasets/TSB-AD-M/')
    parser.add_argument('--file_list', type=str, default='../TSB-AD/Datasets/File_List/TSB-AD-M-Eva.csv')
    parser.add_argument('--score_dir', type=str, default='results_analysis/eval/score/offline')
    parser.add_argument('--save_dir', type=str, default='eval/metrics/offline/')
    parser.add_argument('--save', type=bool, default=True)
    parser.add_argument('--AD_Name', type=str, default='MCD')
    ...
    logging.basicConfig(filename=f'{target_dir}/000_run_{args.AD_Name}_offline.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
