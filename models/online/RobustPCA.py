...
# - Conservative Data Handling: Changed default zero_pruning to False to 
#   preserve the full feature space by default.
...
class RobustPCA(BaseDetector):
    def __init__(self, max_iter: int = 1000, n_components = None, zero_pruning = False):
