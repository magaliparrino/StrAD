...
#
# TSB-AD Note: [TimesNet from "TimesNet: Temporal 2D-Variation Modeling for General Time Series Analysis" (ICLR 2023)
...
from TSB_AD.utils.torch_utility import EarlyStoppingTorch, DataEmbedding, adjust_learning_rate, get_gpu
...
class TimesNet():
    ...
    def decision_function(self, data):
        ...
        test_loader = DataLoader(
            dataset=ReconstructDataset(data_normalized, window_size=self.win_size, normalize=False),
            batch_size=self.batch_size,
            shuffle=False
        )
        #############################################
