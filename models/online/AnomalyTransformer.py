...
#
# TSB-AD Note: [This function is adapted from [Anomaly-Transformer] by [wuhaixu2016] - Original source: [https://github.com/thuml/Anomaly-Transformer]]
#
# MODIFICATIONS IN StrAD:
# - Stateful Feature-wise Scaling: Replaced window-wise (instance) standardization with stateful scaling.
# - Consistent Inference: Updated decision_function() to re-apply exact scaling parameters learned during fit(), ensuring consistency and preventing data leakage.
