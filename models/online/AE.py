...
#
# TSB-AD Note: [This function is adapted from [pyod] by [yzhao062] - Original source: [https://github.com/yzhao062/pyod]]
#
# MODIFICATIONS IN StrAD:
# - Changed point-wise normalization to feature-wise normalization.
# - Updated decision_function() to use stored scaler parameters obtained in fit().
...
from TSB_AD.utils.stat_models import pairwise_distances_no_broadcast
from TSB_AD.utils.dataset import TSDataset
from TSB_AD.utils.utility import get_activation_by_name   
...
class AutoEncoder(BaseDetector):
    ...
    def fit(self, X, y=None):
        ...
        self.scaler_ = MinMaxScaler(feature_range=(0,1))  ## modif: keeping sclaer in memory to re use in decision_function
    ...
    def decision_function(self, X):
        ...
        X = check_array(X)
        X = self.scaler_.transform(X)  ### changed from original implementation
