...
# - Introduced Window3D Class: Added support for multivariate windowing, 
#   generating 3D tensors suitable for deep learning architectures.
...
class Window3D: ### ADDED
    """ The class for rolling window feature mapping.
    Converts the original multivariate time series X into a matrix of sliding windows.
    """
    ...
    def convert(self, X):
        ...
        windows = sliding_window_view(X, window_shape=self.window, axis=0).transpose(0, 2, 1)[::self.stride, :]    
        return windows
